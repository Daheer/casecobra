...
import { createCheckoutSession, getUser } from "./actions"
  ...
  return (
    <>
      <div className="pointer-events-none select-none absolute inset-0 overflow-hidden flex justify-center" aria-hidden="true">
        <Confetti active={showConfetti} config={{ elementCount: 70, spread: 300 }} />
      </div>
          ...
          <div className="grid grid-cols-1 gap-y-8 border-b border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:py-10">
            ...
            <div>
              ...
              <ol className="mt-3 text-zinc-700 list-disc list-inside">
                ...
                <li>Sratch and fingerprint resistant coating</li>
              </ol>
            </div>
          </div>
          <div className="mt-8">
            <div className="bg-gray-50 p-6 sm:rounded-large sm:p-8">
