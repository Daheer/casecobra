...
const Page = async () => {
  ...
  return (
    <div className="flex min-h-screen w-full bg-muted/40">
      <div className="max-w-7xl w-full mx-autio flex flex-col sm:gap-4 sm:py-4">
              ...
              {orders.map((order) => (
                <TableRow key={order.id} className="bg-accent">
                  <TableCell>
                    ...
                    <div className="hidden text-small text-muted-foreground md:inline">{order.user.email}</div>
                  </TableCell>
